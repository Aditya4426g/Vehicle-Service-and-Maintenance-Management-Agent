...
def search_service_centers(
    ...
    # Step 4: Priority 2 - Query Nominatim POI search if Overpass returned no results
    if not centers:
        try:
    ...
    # Step 5: Priority 3 - Local database fallback (guarantees results even when offline)
    ...
    # Step 6: Sort all found centers by distance (closest first)
